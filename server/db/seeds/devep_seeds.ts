...
export async function seed(knex: Knex): Promise<void> {
  ...
  await knex("displays").insert([
    ...
    { id: 3, name: "frosty", ipaddress: "192.168.0.156", led_number: 8 },
  ]);
  // SEED COLOUR
  await knex("colours").insert([
    { id: 1, name: "red", hue: "360", saturation: 70, lightness: 50 },
    { id: 2, name: "blue", hue: "240", saturation: 70, lightness: 50 },
    { id: 3, name: "green", hue: "100", saturation: 70, lightness: 50 },
  ]);
  // SEED SHOWS
